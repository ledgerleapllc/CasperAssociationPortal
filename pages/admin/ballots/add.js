        ...
        <div className="card-body pt-8 pb-28 overflow-y-auto lg:h-100%-70px">
          <div className="lg:pr-24">
            ...
            <div className="mt-4 flex items-center">
              ...
              <button
                type="button"
                className="ml-5 h-16 lg:h-11 w-full text-lg text-primary lg:w-48 rounded-full bg-none border-2 border-primary hover:opacity-40 disabled:opacity-40 disabled:cursor-not-allowed focus:outline-none shadow-md"
              >
                Upload Files
              </button>
            </div>
            ...
            <div className="flex flex-col-reverse lg:flex-wrap lg:flex-row items-center pt-8 justify-between">
              <div className="flex">
                <div className="border border-gray1 mr-4 c-select flex items-center relative min-w-52 focus:outline-none shadow-md">
                  <select className="py-6 px-5 w-full cursor-pointer" required>
                ...
                <div className="border border-gray1 c-select flex items-center relative min-w-52 focus:outline-none shadow-md">
                  <select className="px-5 py-6 w-full cursor-pointer" required>
                    <option selected value="" disabled>
                      Days
                    </option>
                    <option value="1">Day 1</option>
