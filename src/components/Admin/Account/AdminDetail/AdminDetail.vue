	...
	data() {
		return {
			...
			pii: {
				...
				middle_name: this.$root.pii.last_name,
				last_name:   this.$root.pii.middle_name,
		...
		async savePii() {
			...
			const response = await api(
				...
				'admin/save-pii',
				{
					...
					middle_name: this.pii.last_name,
					last_name:   this.pii.middle_name,
	...
	<div class="container-lg pt15">
		...
		<div class="row pt20">
			...
			<div class="col-sm-6 pt15">
				<h6 class="bold">Personal Information</h6>

				<div class="form-group">
					<p class="mt20 op7">
						First Name
					</p>
					<input class="form-control" v-model="pii.first_name">

					<p class="mt10 op7">
						Middle Name (initial)
					</p>
					<input class="form-control" v-model="pii.middle_name">

					<p class="mt10 op7">
						Last Name
					</p>
					<input class="form-control" v-model="pii.last_name">

					<p class="mt10 op7">
						Phone Number
					</p>
					<input class="form-control" v-model="pii.phone">
