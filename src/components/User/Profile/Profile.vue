				...
				<div class="card">
					...
					<div class="card-body">
						<div class="profile-row border-bottom">
							<div 
								v-if="
									this.identifier == this.$root.guid || 
									this.identifier == this.$root.pseudonym
								" 
								class="profile-icon"
							>
								<AvatarBadgeProfile 
								...
								<tr>
									...
									<td class="tr-right">
										...
										<div v-else>
											...
											<span v-else>
												<button v-if="this.identifier == this.$root.guid || this.identifier == this.$root.pseudonym" class="btn btn-sm btn-warning fs13 bold" @click="this.$root.routeTo('/u/get-verified')">
													Get Verified
													<i class="fa fa-check-square-o ml5"></i>
												</button>
												<span v-else class="text-yellow bold">
													Not Verified
												</span>
											</span>
