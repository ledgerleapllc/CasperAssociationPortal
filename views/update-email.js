...
const UpdateEmail = () => {
  ...
  return (
    <>
      <Head>
        <title>Update Email Address - Casper Association Portal</title>
      </Head>
      <div
          ...
          >
            ...
            >
              ...
              <p className="text-xs text-center mt-2 animate__animated animate__fadeInUp animate__delay-0-5s">
                Please enter the email you want to change to. This will resend{' '}
                the code to that email and update the email on your account as{' '}
                well.
              </p>
