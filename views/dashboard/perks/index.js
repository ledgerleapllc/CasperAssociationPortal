...
const DashboardMemberPerks = () => (
  <>
    <Head>
      <title>Perks - Casper Association Portal</title>
    </Head>
    <LayoutDashboard>
      <Card className="h-full px-card py-5 lg:shadow-2xl" noShadow>
        <div className="flex flex-col h-full w-full">
          ...
          <div className="flex flex-col flex-1 min-h-0">
            <p className="py-4">
              Welcome Casper Association member. The following perks are{' '}
              available to you. Click any to learn more. Thanks for being a{' '}
