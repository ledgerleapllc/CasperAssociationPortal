        ...
        <div className="flex-1 chat-content mt-5 lg:m-0">
          <div className="chat-content-body">
            <div className="flex justify-between">
              ...
              >
                <Link to={`/dashboard/discussion/${discuss?.id}`}>
          ...
          <div className="w-full chat-content-footer flex text-sm justify-between flex-col lg:flex-row">
            <p>
              ...
              <Link to={`/dashboard/profile/${discuss?.user?.id}`}>
                <span className="inline-flex gap-2 items-center text-primary font-medium">
