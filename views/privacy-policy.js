...
const PrivacyPolicy = () => {
  ...
  return (
    <>
      <Head>
        <title>Privacy Policy - Casper Association Portal</title>
      </Head>
          ...
          <div className="flex-grow flex items-center justify-center">
            <div className="bg-white w-full lg:w-2/3 px-14 py-14">
              ...
              <p className="mt-3 mb-3">
                ...
                Association ("Company", "we", "us", or "our"). We are committed{' '}
                ...
                please contact us at help@casper.network.
                <br />
              ...
              <p>
                ...
                sources include: social media profile information; marketing{' '}
              ...
              <p>
                ...
                laws, to protect your rights, or to fulfill business Consent We{' '}
              ...
              <p>
                ...
                visit the Sites. These companies may use information about your{' '}
                visits to our Website(s) and other websites that are contained{' '}
                in web cookies and other tracking technologies in order to{' '}
              ...
              <p>
                ...
                keeping your personal information for longer than When we have{' '}
                no ongoing legitimate business need to process your personal
                information, we will either delete or anonymize it, or, if this{' '}
              ...
              <p>
                ...
                Sites, you represent that you are at least 18 or that you are{' '}
                ...
                age 18, please contact us at help@casper.network
              </p>
              <h3 className="mt-5 mb-2">
              ...
              <p>
                ...
                terminate your account at any time. In some regions (like the{' '}
                ...
                affect certain features or services of our Sites. To opt-out of
              ...
              <p>
                ...
                information. 11. HOW CAN YOU CONTACT US ABOUT THIS POLICY? If{' '}
                you have questions or comments about this policy, you may email{' '}
                us at help@casper.network.
              </p>
            </div>
          </div>
        </div>
